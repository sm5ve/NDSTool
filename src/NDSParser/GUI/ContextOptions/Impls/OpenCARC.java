 ...
 */
public class OpenCARC implements FileOperation{
    @Override
    public boolean matches(FilesystemObject obj) {
        if(obj instanceof AbstractFile){
            return NDSParser.Files.FileTypeProvider.Impls.CARC.instance.matches((AbstractFile) obj);
        }
        return false;
    }
    ...
    public void execute(FilesystemObject obj) {
        try {
            NDSParser.Files.NARC.NARC narc = CARC.decode((FileObject) obj);;
            AbstractFolder root;
